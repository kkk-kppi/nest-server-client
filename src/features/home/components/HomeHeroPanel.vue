...
import CounterButton from '@/shared/components/atoms/CounterButton.vue'
import viteLogo from '@/assets/vite.svg'
import heroImg from '@/assets/hero.png'
import vueLogo from '@/assets/vue.svg'

const count = ref(0)
const counterLabel = computed(() => `Count is ${count.value}`)
...
<template>
  <section id="center">
    ...
    <CounterButton :label="counterLabel" @click="incrementCount" />
  </section>
